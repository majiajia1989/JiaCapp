...
import com.e1858.ui.KnowlegeActivity;
import com.e1858.ui.KnowlegeInfo;
...
public class ListViewKnowledgeAdapter extends BaseAdapter {
	...
	private KnowlegeActivity context;
	private List<LibBase> list;
	private int itemResource;
	private long[] ids;
	private LayoutInflater layoutInflater;
	public ListViewKnowledgeAdapter(KnowlegeActivity context,List<LibBase> list,int itemResource){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			...
			vh.title=(TextView)convertView.findViewById(R.id.knowlege_title);
			vh.time=(TextView)convertView.findViewById(R.id.knowlege_time);
		...
		convertView.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent=new Intent(context,KnowlegeInfo.class);
