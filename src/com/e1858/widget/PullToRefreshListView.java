...
public class PullToRefreshListView extends ListView implements OnScrollListener{
	...
	private final static String TAG = "PullToRefreshListView";  //是类的标记，方便调试
    // 下拉刷新标志   
    ...
    private int 					currentScrollState;//滚动状态 
    private int 					state;    
   ...
   //滚动状态改变
    ...
    private void changeHeaderViewByState() {  
        ...
        case DONE:  
            ...
            arrowImageView.clearAnimation();  //结束动画
            // 此处更换图标   
            arrowImageView.setImageResource(R.drawable.pulltorefresh_down_arrow);  
            tipsTextview.setText(R.string.pull_to_refresh_pull_label);  
            lastUpdatedTextView.setVisibility(View.VISIBLE);  //最后一次更新时间可见 
            Log.v(TAG, "当前状态，done");  
            break;  
        }  
    }    
