...
package com.e1858.widget.wheel;
...
public class WheelView extends View {
	...
	//颜色
	private static final int VALUE_TEXT_COLOR = 0xF0EEAD0E;
	private static final int ITEMS_TEXT_COLOR = 0xFFF0FFFF;
	private static final int[] SHADOWS_COLORS = new int[] { 0xFF218868,
			0x00AAAAAA ,0x00AAAAAA};
	private static final int ADDITIONAL_ITEM_HEIGHT = 15;//高度
	//字体大小
