...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_refreshmode)) {
			mode = a.getInteger(R.styleable.PullToRefresh_refreshmode, MODE_PULL_DOWN_TO_REFRESH);
		}
		...
		if (a.hasValue(R.styleable.PullToRefresh_refreshheaderTextColor)) {
			final int color = a.getColor(R.styleable.PullToRefresh_refreshheaderTextColor, Color.BLACK);
			if (null != headerLayout) {
		...
		if (a.hasValue(R.styleable.PullToRefresh_refreshheaderBackground)) {
			this.setBackgroundResource(a.getResourceId(R.styleable.PullToRefresh_refreshheaderBackground, Color.WHITE));
		}
