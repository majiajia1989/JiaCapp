...
public class Encrypt
{
	...
	public static String MD5(String s)
	{
		try
		{
			return Util.byte2HexString(MessageDigest.getInstance("MD5").digest(s.getBytes(Constant.ENCODING)));
		}
		catch (Exception ex)
		{
			Log.e(Constant.TAG_ENCRYPT, ex.getMessage(), ex);
			return null;
		}
	}
	...
	//
	// String encodeStr = new String(base64Encode(encrypted_pass.getBytes()));
	//
	// System.out.println(" encoded " + encodeStr + "encoded length" +
	// encodeStr.length());
	//
	// String decodeStr = new String(base64Decode(encodeStr));
