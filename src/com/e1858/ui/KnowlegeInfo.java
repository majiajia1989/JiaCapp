...
public class KnowlegeInfo extends BaseActivity {
	...
	private TextView  			k_author;
	private TextView  			k_summary;
	private TextView            k_time;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.knowlege_info);
	...
	private void initView(){
		...
		k_title=(TextView)findViewById(R.id.k_title);
		k_author=(TextView)findViewById(R.id.k_author);	
		k_summary=(TextView)findViewById(R.id.k_summary);
		k_time=(TextView)findViewById(R.id.k_time);
		...
		btn_right.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(index<ids.length-1){
					...
					btn_right.setEnabled(false);
					btn_right_before.setEnabled(true);
					ToastUtil.showShort(KnowlegeInfo.this, "已经是最后一条");
				}
			}
		});
		btn_right_before.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(index>0){
					...
					btn_right_before.setEnabled(false);
					btn_right.setEnabled(true);
					ToastUtil.showShort(KnowlegeInfo.this, "已经是最新一条");
				}
			}
		});
		...
		downLoad.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(downLoad.getText().equals("下载附件")){
					downdialog=new Dialog(KnowlegeInfo.this,android.R.style.Theme_Translucent_NoTitleBar);
	...
	public boolean handleMessage(Message msg) {
		...
		case MessageWhat.GET_LIBRARY_RESP:
			if(null!=(String)msg.obj){
				...
				Log.v("knowlegeINFO", (String)msg.obj);
				if(null==getLibraryResp){
					break;
				}
				if(HttpDefine.RESPONSE_SUCCESS==getLibraryResp.getStatus()){
					entity=getLibraryResp.getLibrary();
					k_title.setText(entity.getTitle());		
					if(entity.getAuthor().equals("")){
						k_author.setVisibility(View.GONE);
					}else{
						k_author.setText("作者:"+entity.getAuthor());	
					}
					
					k_summary.setText("\u3000\u3000"+entity.getSummary());
					k_time.setText(DateUtil.dateToZh(DateUtil.strToDatestrLong(entity.getIssuedDate())));
		...
		case MessageWhat.DOWN_OVER:
			downdialog.dismiss();
			downLoad.setText("查看附件");
			ToastUtil.showShort(KnowlegeInfo.this, "已下载完成！");
			break;
		...
		case MessageWhat.DOWNFIELD:
			downdialog.dismiss();
			ToastUtil.showShort(KnowlegeInfo.this, "下载失败！");
			break;
		}
